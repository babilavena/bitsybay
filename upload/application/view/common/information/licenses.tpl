    ...
    <div class="col-lg-9">
      <section>
        <article>
          ...
          <p>An Exclusive License involves selling only one item of the product after which the product is removed from sale and the seller agrees not to publish the product again.</p>
