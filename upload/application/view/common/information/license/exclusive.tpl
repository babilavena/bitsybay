<div class="well">
  <p>
    Exclusive License, EL, refers to the right to use copyrighted Item without the need to pay royalties or license fees for each use or per volume sold, or some time period of use or sales.
    Exclusive License does not mean one and only license granted, but only that the licensor agrees not to put up purchased Item for sale again.
  </p>
</div>
...
<div style="margin-left:20px"><span class="glyphicon glyphicon-circle-arrow-right"></span> The Buyer <strong class="text-danger">shall not</strong> claim Copyright to the Item;</div>
<div style="margin-left:20px;margin-bottom:30px"><span class="glyphicon glyphicon-circle-arrow-right text-warning"></span> The Seller <strong class="text-danger">shall not</strong> to put up purchased Item for sale again.</div>
