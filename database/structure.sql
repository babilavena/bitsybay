...
DROP TABLE IF EXISTS `log_withdraw`;
...
CREATE TABLE IF NOT EXISTS `log_withdraw` (
  ...
  PRIMARY KEY (`log_withdraw_id`),
  INDEX `fk_log_withdraw_currency_id` (`currency_id` ASC),
  INDEX `fk_log_withdraw_order_id` (`order_id` ASC),
  INDEX `fk_log_withdraw_user_id` (`user_id` ASC),
  CONSTRAINT `fk_log_withdraw_currency_id`
    FOREIGN KEY (`currency_id`)
    REFERENCES `currency` (`currency_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_log_withdraw_order_id`
